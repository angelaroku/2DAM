...
import ies.piobaroja.dam2.accesodatos.mensajeria.controladores.AltaEnvioControlador;
...
public class AltaEnvioVista extends JPanel{
	...
	private AltaEnvioControlador controlador;
	...
	//	textFieldDestino.setColumns(10);
		...
		controlador=new AltaEnvioControlador();
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if (cartaRadioButton.isSelected()) {
						...
						controlador.altaCarta(fecha, origen, destino, precio);
						...
						controlador.altaPaquete(fecha, origen, destino, peso, precioKilo);
						JOptionPane.showMessageDialog(JOptionPane.getFrameForComponent(altaButton),"Alta correcta");
						//JOptionPane.showMessageDialog(JOptionPane.getFrameForComponent(altaButton),"Error interno");
